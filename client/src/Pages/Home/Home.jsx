...
const Home = () => {
  ...
  const rentalProperties = [
    ...
    {
      id: 11,
      title: "Luxury 3BHK Serviced Apartment",
      category: "Rental",
      price: "₹65,000/month",
      location: "Andheri West, Mumbai",
      image:
        "https://www.bing.com/th/id/OIP.kwc30lLMaa8fI8lCH135wgHaEx?w=240&h=211&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2",
      beds: 3,
      baths: 3,
      area: "1400 sq ft",
      rating: "4.9",
  ...
  const features = [
    ...
    },
    {
      icon: <AiOutlineCheckCircle className="text-red-600 text-3xl" />,
      title: "No Brokerage",
      description: "Direct contact with owners saves you huge brokerage fees.",
    },
    {
      icon: <AiOutlineCheckCircle className="text-red-600 text-3xl" />,
      title: "Easy Search",
      description: "Advanced filters and search options for quick results.",
    },
  ];
  ...
  const trustFeatures = [
    {
      ...
      title: "Verified Listings",
      description: "Every property undergoes 3-step verification process",
    },
    {
  ...
  return (
    <div className="font-sans text-gray-800">
      {/* Hero Section */}
      <section className="mt-20 relative  h-[70vh] flex flex-col justify-center items-center text-center bg-gray-50 px-6">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-4 sm:space-y-6 max-w-5xl w-full">
          {/* ✅ Main Heading */}
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-[700] text-red-600 leading-tight">
            Welcome to <span className="text-blue-900">DealDirect</span>
          </h1>

          {/* ✅ Sub Heading */}
          <h2 className="text-xl sm:text-2xl md:text-3xl font-[700] text-gray-800">
            Find Your <span className="">Dream Home</span>
          </h2>

          {/* ✅ Description */}
          <p className="text-gray-600 text-base sm:text-lg md:text-[18px] max-w-2xl">
            Search from verified listings and connect directly with property
            owners — no middlemen, no hassle.
          </p>

          {/* ✅ Search Box */}
          <div className="bg-white shadow-xl rounded-full max-w-3xl flex w-full sm:mt-6 border border-gray-200 focus-within:ring-2 focus-within:ring-red-500 transition-all duration-300">
            <input
              type="text"
              placeholder="Search by city, locality, or project..."
              className="flex-1 md:h-16 px-6 py-2  text-gray-700 text-sm sm:text-base rounded-full focus:outline-none"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <button className="bg-red-600  hover:bg-red-700 text-white px-6 sm:px-10 py-4 rounded-full font-semibold flex items-center justify-center gap-2 transition-all duration-300">
      ...
      <section className=" py-8 bg-white">
        <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {stats.map((stat, idx) => (
            ...
            >
              <div className="text-2xl md:text-3xl font-bold mb-1 text-red-600">
                {stat.number}
              </div>
      ...
      <section className="relative h-96 bg-cover bg-center bg-no-repeat flex items-center justify-center text-white text-center px-6">
        ...
        <div className="relative z-10 max-w-4xl space-y-6">
          <h2 className="text-4xl md:text-6xl font-bold leading-tight">
            ...
            <br />a Home Filled with Love
          </h2>
          <p className="text-xl md:text-2xl opacity-90">
            Your journey to finding the perfect home starts here
          </p>
          <button className="bg-red-600 hover:bg-blue-800 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
            Find My Home
          </button>
        </div>
      </section>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full font-semibold border transition ${
                selectedCategory === cat
                  ...
                  : "bg-white text-blue-800 border-blue-800 hover:bg-blue-800 hover:text-white"
              }`}
            >
              {cat}
            </button>
            ...
            >
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="flex gap-4 text-gray-600 text-sm mt-2">
                  ...
                  <span className="flex items-center gap-1">
                    <FaVectorSquare className="text-blue-800" /> {property.area}
                  </span>
                </div>
            ...
            {premiumProperties.map((property) => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-blue-800 text-white px-3 py-1 rounded-full text-sm font-bold">
                    {property.tag}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex gap-4 text-gray-600 text-sm mb-4">
                    ...
                    <span className="flex items-center gap-1">
                      <FaBath className="text-blue-800" /> {property.baths}{" "}
                      Baths
                    </span>
                    <span className="flex items-center gap-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-red-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-800 transition">
                      View Details
                    </button>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Properties with highest sales this month
                </p>
              </div>
              <button className="bg-blue-800 text-white px-6 py-3 rounded-full font-semibold hover:bg-red-600 transition">
                View All
              </button>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 flex items-center gap-3">
                  <AiOutlineStar className="text-blue-800" /> Most Rented
                  Properties
                </h2>
                <p className="text-gray-600 mt-2">
                  Highly sought-after rental homes
                </p>
              </div>
                ...
                >
                  <div className="relative overflow-hidden">
                    <img
                      ...
                      className="w-full h-65 object-cover group-hover:scale-105 transition duration-500"
                    />
                    <div className="absolute top-3 left-3 bg-blue-800 text-white px-3 rounded-full py-2 text-xs font-bold">
                      POPULAR RENTAL
                    </div>
                  </div>
                  <div className="p-5">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              India's most trusted real estate platform with transparent,
              verified, and broker-free property transactions
            </p>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="bg-white px-6 py-6 rounded-xl shadow-lg text-center space-y-4 hover:shadow-xl transition border border-blue-100"
              >
