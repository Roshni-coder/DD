...
function SampleAgreement() {
  ...
  return (
    <div className="min-h-screen mt-20 sm:mt-28 py-12 px-4 sm:px-8 lg:px-20 bg-gray-50">
      {/* 🛡️ Header */}
      <div className="text-center mb-16">
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="absolute inset-0 bg-blue-100 rounded-full blur-lg opacity-50 animate-pulse"></div>
            <FaShieldAlt className="relative text-blue-800 text-4xl sm:text-5xl z-10" />
          </div>
        </div>

        <h1 className="text-3xl sm:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-800 to-indigo-900 bg-clip-text text-transparent">
          Verified Rent Agreements
        </h1>

        <p className="text-gray-700 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed px-2">
        ...
        {/* 🏅 Trust Badges */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mt-10 sm:mt-12 max-w-4xl mx-auto">
          {trustFeatures.map((feature, index) => (
            <div
              key={index}
              className="bg-white/90 backdrop-blur-sm rounded-xl p-4 sm:p-5 shadow-sm border border-gray-100 hover:shadow-lg hover:border-blue-200 transition-all duration-300"
            >
              <div className="flex flex-col items-center text-center">
                <feature.icon className="text-blue-800 text-xl sm:text-2xl mb-3" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
        {agreements.map((agreement, index) => (
          <div
            key={index}
            className="group bg-white rounded-2xl p-6 sm:p-8 flex flex-col items-center text-center shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-100 relative overflow-hidden"
          >
            {/* Verified Badge */}
            <div className="absolute top-4 right-4 bg-green-500 text-white px-3 py-1 rounded-full text-[11px] sm:text-xs font-semibold flex items-center gap-1">
              <FaCheckCircle className="text-white" />
              Verified
            </div>

            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-[0.03] bg-gradient-to-br from-blue-800 to-indigo-900"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full">
                <a
                  ...
                  className="flex-1 bg-gradient-to-r from-blue-800 to-blue-900 text-white px-5 py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 hover:from-blue-600 hover:to-blue-700 hover:shadow-lg transform hover:scale-105 transition-all duration-300 shadow-md"
                >
      ...
      <div className="mt-16 sm:mt-20 text-center">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 max-w-4xl mx-auto shadow-md border border-gray-200">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4">
            <FaLock className="text-green-500 text-lg sm:text-xl" />
